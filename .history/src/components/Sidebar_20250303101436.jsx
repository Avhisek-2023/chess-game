...
const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 h-full overflow-y-auto w-64 bg-sidebar text-white shadow-lg transition-all ease-in-out duration-20000 z-[100] ${
        ...
        {moveHistory.map((move, index) => (
          <li
            ...
            className={` py-1 font-bold textt-lg ${
              move.from === "player" ? "text-white" : "text-black"
            }`}
          >
            {index + 1}. {move.move}
            <span> [{move.from}]</span>
