    ...
    >
      <div className="absolute flex gap-4 sm:gap-8 left-4 sm:left-10 top-10 sm:top-28">
        ...
        <div className="flex items-center gap-2">
          <span className="w-6 h-6 bg-black border-2 border-gray-700 rounded-full sm:w-7 sm:h-7"></span>
          <span
            className={`text-2xl font-semibold text-white  sm:text-xl ${
              mode === "two-player" ? "rotate-180" : ""
            }`}
          >
            {pieceCount.black}
          </span>
