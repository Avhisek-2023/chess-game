  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[90vw] sm:max-w-[80vw] md:max-w-[60vw] lg:max-w-[40vw] min-w-[300px] aspect-square mx-auto my-auto">
        ...
        >
          {board.map((row, i) => (
            <>
              <div
                key={i}
                className="absolute left-0 font-sans text-xsm text-white md:text-lg"
                style={{
                  top: `${(i + 0.15) * 12.5}%`,
        ...
        <div className="absolute bottom-2 right-1 w-full grid grid-cols-8 text-right text-white  font-sans text-xsm ">
