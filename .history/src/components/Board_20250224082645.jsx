...
const Board = () => {
  const { board, handlePieceClick, selected, validMoveCells, turn } =
    useBoardContext();
  ...
  return (
    ...
    >
      <div className="absolute flex gap-4 sm:gap-8 left-4 sm:left-10 top-10 sm:top-28">
        ...
        >
          <img src={bot} alt="Player 1" className="w-12 sm:w-16 md:w-20" />
        </div>
      </div>
      <div
      ...
      <div className="absolute flex gap-4 right-4 sm:right-10 bottom-10 sm:bottom-28 sm:gap-8">
        <div
