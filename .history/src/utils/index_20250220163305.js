...
export const movePiece = (fromRow, fromCol, toRow, toCol, board) => {
  ...
  const movingPiece = newBoard[fromRow][fromCol].piece; // Extract only piece

  newBoard[toRow][toCol].piece = movingPiece; // Move piece
  newBoard[fromRow][fromCol].piece = null; // Clear original position
